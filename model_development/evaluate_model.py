...
def main():
    ...
    # This part is duplicated from train.py but is necessary to ensure
    # the test set is generated from the same data.
    # A more advanced setup might save the scaled test arrays directly.
    ...
    # Use a threshold of 0.5 for classification report
